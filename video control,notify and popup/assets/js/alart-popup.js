...
function showLeavePOPup (){
    var popupWappper = document.getElementById('al-alert-popup'); //popup main Wrapper 
    ...
    var secondShowWapper = document.getElementById('secondCount'); // popup second show Wrapper  
    var muniteShowWapper = document.getElementById('munuteCount'); // pupup munite show Wrapper 
    var myTimer; //set time interval const
    var countMunite = 39; // define count time in munite
    ...
    var intervalCount = 0; 
    var eventStart = document.getElementById('popupdoNotRemoveThis');

    eventStart.addEventListener('mouseover',showAlartPopup); // show popup event
...
const windowloadtimeout = setTimeout(showLeavePOPup, 5000);